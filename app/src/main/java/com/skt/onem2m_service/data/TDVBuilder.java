...
public class TDVBuilder {
     ...
     * @return
     */
    public TDVBuilder addSensorTime(long nowMillis) {
        int nowSecond = (int) (nowMillis/1000);
        Log.e("TDVBuilder", "Current Time is:"+ nowMillis +"msec ("+ nowSecond +" sec)= "+ DateFormat.getDateTimeInstance().format(new Date(nowMillis)) );
    ...
    public static List<SensorInfo> parseSensorData(String tdvString) {
        ...
        for (int loop1 = 0 ; loop1 < tdvString.length() ; ) {
            ...
            switch (type) {
                ...
                case 0x25:  sensorType = SensorType.RELATIVE_HUMIDITY;      intValues[0] = convertStrToFloat(value);                            break;  // humidity
                ...
                case 0x12:  sensorType = SensorType.LIGHT;                  intValues[0] = Long.parseLong(value, 16);                           break;  // light
                case 0xF0:  sensorType = SensorType.BUZZER;                 intValues[0] = Long.parseLong(value, 16);                           break;  // buzzer

                case 0x26:  sensorType = SensorType.FAN;                    intValues[0] = Long.parseLong(value, 16);                           break;  // fan
                case 0x27:  sensorType = SensorType.DOOR;                   intValues[0] = Long.parseLong(value, 16);                           break;  // door
                case 0x28:  sensorType = SensorType.LED;                    intValues[0] = Long.parseLong(value, 16);                           break;  // led

                case 0x30:  sensorType = SensorType.SWITCH;                 stringValues[0] = (Long.parseLong(value, 16) == 0 ? "Off":"On");    break;  // switch
