...
public class UserInfo {
    ...
    private static final String KEY_SETTING_SHOW_CONTENT  = "showContent";
     ...
     * @param showContent
     */
    public void saveShowContent(boolean showContent) {
        editor.putBoolean(KEY_SETTING_SHOW_CONTENT, showContent);
        editor.commit();
    }
     ...
     * @return showContent
     */
    public boolean loadShowContent() {
        return sharedPreference.getBoolean(KEY_SETTING_SHOW_CONTENT, Const.SHOW_CONTENT_DEFAULT);
    }
