...
public enum SensorType {
    ...
    AMBIENT_TEMPERATURE        (Category.SENSOR_MANAGER,    "Temperature",                  R.mipmap.icon_temperature_big,      ValueType.NUMBER,   new int[]{0x11},                new int[]{0x11},                new int[]{2},           new String[][]{{"temperature", "℃"}}),                              // This constant was deprecated in API level 14. use Sensor.TYPE_AMBIENT_TEMPERATURE instead.
    RELATIVE_HUMIDITY          (Category.SENSOR_MANAGER,    "Humidity",                     R.mipmap.icon_humidity_big,         ValueType.NUMBER,   new int[]{0x25},                new int[]{0x25},                new int[]{2},           new String[][]{{"Air humidity", "%"}}),                                     // A constant describing a relative humidity sensor type.
    ...
    LIGHT                      (Category.SENSOR_MANAGER,    "Light",                        R.mipmap.icon_light_big,            ValueType.NUMBER,   new int[]{0x12},                new int[]{0x12},                new int[]{0},           new String[][]{{"Level", "㏓"}}),                                           // A constant describing a light sensor type.
    BUZZER                     (Category.ACTUATOR,          "Buzzer",                       R.mipmap.icon_buzzer_big,           ValueType.NUMBER,   new int[]{0xF0},                new int[]{0xF0},                new int[]{0},           new String[][]{{"", ""}}),

    FAN                        (Category.ACTUATOR,          "Fan",                          R.mipmap.icon_fan_big,              ValueType.NUMBER,   new int[]{0x26},                new int[]{0x26},                new int[]{0},           new String[][]{{"", ""}}),
    DOOR                       (Category.ACTUATOR,          "Door",                         R.mipmap.icon_door_opened_big,      ValueType.NUMBER,   new int[]{0x27},                new int[]{0x27},                new int[]{0},           new String[][]{{"", ""}}),
    LED                        (Category.ACTUATOR,          "Led",                          R.mipmap.icon_color_big,            ValueType.NUMBER,   new int[]{0x28},                new int[]{0x28},                new int[]{0},           new String[][]{{"", ""}}),

    SWITCH                     (Category.SENSOR_MANAGER,    "Switch",                       R.mipmap.icon_onoff_on_big,         ValueType.STRING,   new int[]{0x30},                new int[]{0x30},                new int[]{0},           new String[][]{{"Status", "Off"}}),                                        // A constant describing a proximity sensor type.
...
//    STEP_COUNTER               (Category.SENSOR_MANAGER,    "Step Count",                   R.mipmap.icon_motion_on_big,        ValueType.NUMBER,   new int[]{0x3E},                new int[]{0x33},                new int[]{0},           new String[][]{{"Count", "steps"}}),                                        // A constant describing a step counter sensor.
    ACCELEROMETER              (Category.SENSOR_MANAGER,    "Accelerometer",                R.mipmap.icon_accelerometer_big,    ValueType.NUMBER,   new int[]{0x41, 0x42, 0x43},    new int[]{0x41, 0x42, 0x43},    new int[]{2, 2, 2},     new String[][]{{"X", "㎨"}, {"Y", "㎨"}, {"Z", "㎨"}}),                     // A constant describing an accelerometer sensor type.
    ORIENTATION                (Category.SENSOR_MANAGER,    "Orientation",                  R.mipmap.icon_windvane_big,         ValueType.NUMBER,   new int[]{0x44, 0x45, 0x46},    new int[]{0x44, 0x45, 0x46},    new int[]{0, 0, 0},     new String[][]{{"Azimuth", "˚"}, {"Pitch", "˚"}, {"Roll", "˚"}}),           // This constant was deprecated in API level 8. use SensorManager.getOrientation() instead.
    GRAVITY                    (Category.SENSOR_MANAGER,    "Gravity",                      R.mipmap.icon_weight_big,           ValueType.NUMBER,   new int[]{0x47, 0x48, 0x49},    new int[]{0x47, 0x48, 0x49},    new int[]{2, 2, 2},     new String[][]{{"X", "㎨"}, {"Y", "㎨"}, {"Z", "㎨"}}),                     // A constant describing a gravity sensor type.
    GYROSCOPE                  (Category.SENSOR_MANAGER,    "Gyroscope",                    R.mipmap.icon_rotaryangle_big,      ValueType.NUMBER,   new int[]{0x4A, 0x4B, 0x4C},    new int[]{0x4A, 0x4B, 0x4C},    new int[]{2, 2, 2},     new String[][]{{"X", "˚"}, {"Y", "˚"}, {"Z", "˚"}}),                        // A constant describing a gyroscope sensor type.
    MAGNETIC_FIELD             (Category.SENSOR_MANAGER,    "Magnetic Field",               R.mipmap.icon_vibration_big,        ValueType.NUMBER,   new int[]{0x4D, 0x4E, 0x4F},    new int[]{0x4D, 0x4E, 0x4F},    new int[]{2, 2, 2},     new String[][]{{"X", "µT"}, {"Y", "µT"}, {"Z", "µT"}}),                     // A constant describing a magnetic field sensor type.
    STEP_DETECTOR              (Category.SENSOR_MANAGER,    "Step Detector",                R.mipmap.icon_motion_on_big,        ValueType.NUMBER,   new int[]{0x3D},                new int[]{0x32},                new int[]{0},           new String[][]{{"Detection", ""}}),                                         // A constant describing a step detector sensor.
    STEP_COUNTER               (Category.SENSOR_MANAGER,    "Step Count",                   R.mipmap.icon_motion_on_big,        ValueType.NUMBER,   new int[]{0x3E},                new int[]{0x33},                new int[]{0},           new String[][]{{"Count", "steps"}}),                                        // A constant describing a step counter sensor.
...
//    STATIONARY_DETECT          (Category.SENSOR_MANAGER,    "STATIONARY_DETECT",            R.mipmap.ic_launcher,               ValueType.NUMBER,   new int[]{0x00},                new int[]{0x00},                new int[]{0},           new String[][]{{"", ""}}),                                                  // A constant describing a stationary detect sensor.
    DEVICE                     (Category.ACTUATOR,          "Device",                       -1,                                 ValueType.NUMBER,   new int[]{0xFF},                new int[]{0xFF},                new int[]{0},           null),
